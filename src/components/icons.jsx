...
export const HomeIcon = ({ className = 'w-6 h-6' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor">
    <path d="M3 10.5L12 3l9 7.5V21a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1v-10.5z" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
...
export const CloudIcon = ({ className = 'w-6 h-6' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor">
    <path d="M17.5 19a4.5 4.5 0 0 0 0-9 5.5 5.5 0 0 0-10.5 1.5A4 4 0 0 0 7 19h10.5z" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

export const CloudRainIcon = ({ className = 'w-6 h-6' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor">
    <path d="M17.5 18a4.5 4.5 0 0 0 0-9 5.5 5.5 0 0 0-10.5 1.5A4 4 0 0 0 7 18h10.5z" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M8 20l1-2M12 20l1-2M16 20l1-2" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);
